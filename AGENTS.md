...
This is a **Kotlin Multiplatform MCP (Model Context Protocol) Audio Tools Server** that provides audio processing capabilities as MCP tools. The project implements an MCP server that can be used with Codex Desktop and other MCP clients.
